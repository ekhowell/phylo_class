...
# NCBI NM_144809 FASTA: https://genome.ucsc.edu/cgi-bin/hgc?hgsid=1080375821_FJSmc4eCngL0GWqqhRpJvm7VcB5g&g=htcDnaNearGene&i=NM_144809&c=chr17&l=15553233&r=15564340&o=refGene&boolshad.hgSeq.promoter=0&hgSeq.promoterSize=1000&boolshad.hgSeq.utrExon5=0&hgSeq.cdsExon=on&boolshad.hgSeq.cdsExon=0&boolshad.hgSeq.utrExon3=0&boolshad.hgSeq.intron=0&boolshad.hgSeq.downstream=0&hgSeq.downstreamSize=1000&hgSeq.granularity=feature&hgSeq.padding5=0&hgSeq.padding3=0&boolshad.hgSeq.splitCDSUTR=0&hgSeq.casing=upper&boolshad.hgSeq.maskRepeats=0&hgSeq.repMasking=lower&submit=submit
...
# Should be able to run MUSCLE using the command
...
# Combined CDS within each fasta, then merge all of the fastas together by running this script in the sequences directory
